...
class CMSCirculars extends StatefulWidget
{
  @override
  _CMSCircularsState createState() => _CMSCircularsState();
}

class _CMSCircularsState extends State<CMSCirculars> {
  int i = 0;
  PdfPages pdf;
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection('CMS_Circulars').orderBy('timeStamp').snapshots(),
